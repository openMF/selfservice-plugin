...
public class SelfServiceClientReadPlatformServiceImpl
    implements SelfServiceClientReadPlatformService {
  ...
  public Page<ClientData> retrieveAll(final SelfServiceSearchParameters searchParameters) {
    ...
    if (searchParameters != null) {
      ...
      final String extraCriteria =
          buildSqlStringFromClientCriteria(
              this.clientToDataMapper.schema(), searchParameters, paramList);
    ...
    return this.paginationHelper.fetchPage(
        this.jdbcTemplate, sqlBuilder.toString(), paramList.toArray(), this.clientToDataMapper);
  }
  ...
  public ClientData retrieveOne(final Long clientId) {
    try {
      ...
      final Collection<ClientCollateralManagement> clientCollateralManagements =
          this.clientCollateralManagementRepositoryWrapper.getCollateralsPerClient(clientId);
      ...
      for (ClientCollateralManagement clientCollateralManagement : clientCollateralManagements) {
        ...
        clientCollateralManagementDataSet.add(
            new ClientCollateralManagementData(
                clientCollateralManagement.getId(),
                clientCollateralManagement.getCollaterals().getName(),
                clientCollateralManagement.getQuantity(),
      ...
      final Collection<GroupGeneralData> parentGroups =
          this.jdbcTemplate.query(
              clientGroupsSql,
              this.clientGroupsMapper, // NOSONAR
              clientId);

      return ClientData.setParentGroups(
          clientData, parentGroups, clientCollateralManagementDataSet);
  ...
  public Collection<ClientData> retrieveAllForLookupByOfficeId(final Long officeId) {
    ...
    return this.jdbcTemplate.query(
        sql, this.lookupMapper, officeId, ClientStatus.CLOSED.getValue()); // NOSONAR
  }
  ...
  public Collection<ClientData> retrieveClientMembersOfGroup(final Long groupId) {
    ...
    return this.jdbcTemplate.query(
        sql, this.membersOfGroupMapper, hierarchySearchString, groupId); // NOSONAR
  }
  ...
  public Collection<ClientData> retrieveActiveClientMembersOfGroup(final Long groupId) {
    ...
    return this.jdbcTemplate.query(
        sql,
        this.membersOfGroupMapper, // NOSONAR
  ...
  public ClientData retrieveClientByIdentifier(
    ...
    try {
      ...
      return this.jdbcTemplate.queryForObject(
          sql, mapper, identifierTypeId, identifierKey); // NOSONAR
    } catch (final EmptyResultDataAccessException e) {
      return null;
    }
  }
