...
public class PinExternalTransferService {
    ...
    /**
     * Extrae dinámicamente las propiedades de la tabla c_external_service_properties
     * según el nombre del servicio PinService.
     */
    ...
    public String executePinTransfer(PinTransferRequest request) {
        ...
        String url = getHost(props) + "/transfers/transfer";
    ...
    private String executeGetRequest(String url, HttpHeaders headers) {
        try {
            ...
            throw new RuntimeException("Failed to execute external account info fetch: " + e.getMessage(), e);
        }
    }
}