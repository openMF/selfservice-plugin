...
@Tag(
    ...
    description =
        "A Loan product is a template that is used when creating a loan. Much of the template"
            + " definition can be overridden during loan creation.\n"
            + "\n"
            + "Field Descriptions\n"
            + "name\n"
            ...
            + "Override the default value for rounding instalment amount to multiples of value"
            + " provided.\n"
            + "principal\n"
            ...
            + "This value will be supported along with interestCalculationPeriodType as Same as"
            + " repayment period to calculate interest for partial periods. Example: Interest"
            + " charged from is 5th of April , Principal is 10000 and interest is 1% per month then"
            + " the interest will be (10000 * 1%)* (25/30) , it calculates for the month first then"
            + " calculates exact periods between start date and end date(can be a decimal)\n"
            + "inArrearsTolerance\n"
            + "The amount that can be 'waived' at end of all loan payments because it is too small"
            + " to worry about.\n"
            ...
            + " against principal outstanding to add another repayment instalment. If the"
            + " outstanding principal amount is less then calculated amount, remaining outstanding"
            + " amount will be added to current instalment. Default value for multi disburse loan"
            + " is 50% and non-multi disburse loan is 0%\n"
            ...
            + " Logic.\n"
            + "A number of out of the box approaches exist, some are custom to specific MFIs, some"
            + " are more general and indicate the order in which payments are processed.\n"
            + "\n"
            + "Refer to the Payment Application Logic / Transaction Processing Strategy section in"
            + " the appendix for more detailed overview of each available payment application logic"
            ...
            + "Optional: Integer - represents the number of repayment periods that grace should"
            + " apply to the principal component of a repayment period.\n"
            + "graceOnInterestPayment\n"
            + "Optional: Integer - represents the number of repayment periods that grace should"
            + " apply to the interest component of a repayment period. Interest is still calculated"
            + " but offset to later repayment periods.\n"
            + "graceOnInterestCharged\n"
            + "Optional: Integer - represents the number of repayment periods that should be"
            + " interest-free.\n"
            + "graceOnArrearsAgeing\n"
            + "Optional: Integer - Used in Arrears calculation to only take into account loans that"
            + " are more than graceOnArrearsAgeing days overdue.\n"
            + "overdueDaysForNPA\n"
            + "Optional: Integer - represents the maximum number of days a Loan may be overdue"
            + " before being classified as a NPA (non performing asset)\n"
            + "accountMovesOutOfNPAOnlyOnArrearsCompletion\n"
            + "Optional: Boolean - if provided as true, Loan Account moves out of NPA state only"
            + " when all arrears are cleared\n"
            + "accountingRule\n"
            + "Specifies if accounting is enabled for the particular product and the type of the"
            + " accounting rule to be used Example Values:1=NONE, 2=CASH_BASED, 3=ACCRUAL_PERIODIC,"
            + " 4=ACCRUAL_UPFRONT\n"
            ...
            + "Specifies effective date from which the compounding of interest or fee amounts will"
            + " be considered in recalculation on late payment.\n"
            ...
            + "Specifies effective date from which the late or advanced payment amounts will be"
            + " considered in recalculation.\n"
            + "Example Values:1=Same as repayment period, 2=Daily, 3=Weekly, 4=Monthly\n"
